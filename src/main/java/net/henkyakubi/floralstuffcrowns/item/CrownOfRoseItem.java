...
import net.henkyakubi.floralstuffcrowns.procedures.CrownOfRoseHelmetTickEventProcedure;
...
public class CrownOfRoseItem extends FloralstuffcrownsModElements.ModElement {
	@ObjectHolder("floralstuffcrowns:crown_of_rose_helmet")
	public static final Item helmet = null;
	@ObjectHolder("floralstuffcrowns:crown_of_rose_chestplate")
	public static final Item body = null;
	@ObjectHolder("floralstuffcrowns:crown_of_rose_leggings")
	public static final Item legs = null;
	@ObjectHolder("floralstuffcrowns:crown_of_rose_boots")
	public static final Item boots = null;
	public CrownOfRoseItem(FloralstuffcrownsModElements instance) {
		super(instance, 33);
	}
		...
		elements.items
				.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(TabFloralStuffCrownsItemGroup.tab)) {
					...
					public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
						return "floralstuffcrowns:textures/models/armor/crown_of_rose-v2__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1")
								+ ".png";
					}
